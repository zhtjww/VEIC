...
from .meta_pvoc import register_p_voc
...
# -------- Pseudo Labeled VOC -------- #
def register_all_pvoc(root="datasets"):
    ...
    for name, imgdir, annofile, split in METASPLITS:
        register_p_voc(
            name,
            _get_builtin_metadata("pvoc_fewshot"),
            os.path.join(root, imgdir),
            os.path.join(root, annofile),
            split
        )
...
def register_all_voc(root="datasets"):
    ...
    METASPLITS = [
        ...
        ("voc_2007_trainval_novel1", "VOC2007", "trainval", "novel1", 1),
        ("voc_2007_trainval_novel2", "VOC2007", "trainval", "novel2", 2),
        ("voc_2007_trainval_novel3", "VOC2007", "trainval", "novel3", 3),
        ("voc_2012_trainval_novel1", "VOC2012", "trainval", "novel1", 1),
        ("voc_2012_trainval_novel2", "VOC2012", "trainval", "novel2", 2),
        ("voc_2012_trainval_novel3", "VOC2012", "trainval", "novel3", 3),
