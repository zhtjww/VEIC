...
def register_p_voc(name, metadata, imgdir, annofile, sid):
    ...
    metadata["thing_classes"] = metadata["thing_classes"][sid]
    metadata["base_classes"] = metadata["base_classes"][sid]
    metadata["novel_classes"] = metadata["novel_classes"][sid]
